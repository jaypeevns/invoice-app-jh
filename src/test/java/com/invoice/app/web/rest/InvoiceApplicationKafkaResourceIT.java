...
import com.invoice.app.config.KafkaProperties;
...
class InvoiceApplicationKafkaResourceIT {
    ...
    void setup() {
        ...
        InvoiceApplicationKafkaResource kafkaResource = new InvoiceApplicationKafkaResource(kafkaProperties);
    ...
    void producesMessages() throws Exception {
        restMockMvc
            .perform(post("/api/invoice-application-kafka/publish/topic-produce?message=value-produce"))
    ...
    void consumesMessages() throws Exception {
        ...
        MvcResult mvcResult = restMockMvc
            .perform(get("/api/invoice-application-kafka/consume?topic=topic-consume"))
            .andExpect(status().isOk())
