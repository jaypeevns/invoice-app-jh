...
@RestController
@RequestMapping("/api/invoice-application-kafka")
public class InvoiceApplicationKafkaResource {
    private final Logger log = LoggerFactory.getLogger(InvoiceApplicationKafkaResource.class);

    private final KafkaProperties kafkaProperties;
    private KafkaProducer<String, String> producer;
    private ExecutorService sseExecutorService = Executors.newCachedThreadPool();

    public InvoiceApplicationKafkaResource(KafkaProperties kafkaProperties) {
